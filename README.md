...
## Dependency
This project contains the modifications of [Segment Anything](https://github.com/facebookresearch/segment-anything), [MaskDINO](https://github.com/IDEA-Research/MaskDINO), [Grounding-DINO](https://github.com/IDEA-Research/GroundingDINO), [MobileSAM](https://github.com/ChaoningZhang/MobileSAM)and [pytorch-CycleGAN-and-pix2pix](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) 
